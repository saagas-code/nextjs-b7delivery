...
import { ButtonWithIcon } from "../../components/ButtonWithcon";
		...
		<div className={styles.container}>
			...
			<div className={styles.infoGroup}>
				<div className={styles.infoArea}>
					<div className={styles.infoTite}>Endereco</div>
					<div className={styles.infoBody}>
						<ButtonWithIcon
							color={data.tenant.mainColor}
							leftIcon={"location"}
							rightIcon={'right'}
							value={shippingAddress ? `${shippingAddress.street} ${shippingAddress.number} - ${shippingAddress.city}` : 'Escolha um endereco'}
							onClick={handleChangeAddress}
						/>
					</div>
				</div>
				<div className={styles.infoArea}>
					<div className={styles.infoTite}>Tipo de Pagamento</div>
					<div className={styles.infoBody}>
				...
				{paymentType === 'money' &&
					<div className={styles.infoArea}>
						<div className={styles.infoTite}>Troco</div>
						<div className={styles.infoBody}>
							<InputField
								color={data.tenant.mainColor}
				...
				<div className={styles.infoArea}>
					<div className={styles.infoTite}>Cupom de Desconto</div>
					<div className={styles.infoBody}>
						{cupom &&
							<ButtonWithIcon
								color={data.tenant.mainColor}
			...
			<div className={styles.resumeArea}>
				...
				<div className={styles.resumeItem}>
					...
					<div style={{ color: data.tenant.mainColor }} className={styles.resumeRightBig}>{formatter.formatPrice(shippingPrice + (subTotal - cupomDiscount))}</div>
				</div>
